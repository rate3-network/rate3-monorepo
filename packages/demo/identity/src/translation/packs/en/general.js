export default {
  ...
  whatIsThisPara3: 'A verifier refers to someone who receives and verifies the data off-chain. On successful verification, the verifier signs the data and return it to the user.',

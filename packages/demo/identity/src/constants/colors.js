export const identityBlue = '#4392F1';
export const identityBlueLight = '#56CBF9';
...
// Role Switch
export const toggleButtonBg = '#EAF9FF';
export const toggleGrey = '#F3F3F3';
export const buttonTextGrey = '#C4CAD6';
